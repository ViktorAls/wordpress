...
if( !function_exists( 'otw_bsw_init' ) ){
	...
	function otw_bsw_init(){
		...
		global $otw_bsw_plugin_url, $otw_bsw_plugin_options, $otw_bsw_shortcode_component, $otw_bsw_shortcode_object, $otw_bsw_form_component, $otw_bsw_validator_component, $otw_bsw_form_object, $otw_bsw_skin, $wp_bsw_cs_items, $otw_bsw_factory_component, $otw_bsw_factory_object, $otw_bsw_plugin_id;
		...
		$otw_bsw_factory_object->add_plugin( $otw_bsw_plugin_id, dirname( dirname( __FILE__ ) ).'/otw_content_manager.php', array( 'menu_parent' => 'otw-bsw-settings', 'lc_name' => __( 'License Manager', 'otw_bsw' ), 'menu_key' => 'otw-bsw' ) );
